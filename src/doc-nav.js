...
export const DOC_NAV_ITEMS = [
  ...
  { section: 'pkg-fast-platform', title: 'fast-platform', icon: 'server', category: 'ecosystem' },
  { section: 'pkg-fast-middleware', title: 'fast-middleware', icon: 'shield', category: 'ecosystem' },
  { section: 'pkg-fast-database', title: 'fast-database', icon: 'database', category: 'ecosystem' },
  { section: 'pkg-fast-dashboards', title: 'fast-dashboards', icon: 'layout-dashboard', category: 'ecosystem' },
