...
export const DOC_NAV_ITEMS = [
  ...
  { section: 'pkg-fastx-platform', title: 'fastx-platform', icon: 'server', category: 'ecosystem' },
  { section: 'pkg-fastx-middleware', title: 'fastx-middleware', icon: 'shield', category: 'ecosystem' },
  { section: 'pkg-fastx-database', title: 'fastx-database', icon: 'database', category: 'ecosystem' },
  { section: 'pkg-fastx-dashboards', title: 'fastx-dashboards', icon: 'layout-dashboard', category: 'ecosystem' },
  { section: 'pkg-fast-channels', title: 'fastx-channels', icon: 'radio', category: 'ecosystem' },
  { section: 'pkg-fastx-mvc', title: 'fastx-mvc (CLI)', icon: 'terminal', category: 'ecosystem' },
  { type: 'divider' },
  ...
  { section: 'guide-mock-server', title: 'Mock Server', icon: 'server', category: 'how-to' },
  { section: 'guide-load-testing', title: 'Load Testing', icon: 'activity', category: 'how-to' },
  { section: 'guide-security-audit', title: 'Security Audit', icon: 'shield-check', category: 'how-to' },
  { section: 'guide-migrate-auto', title: 'Auto Migrations', icon: 'database', category: 'how-to' },
  { type: 'divider' },
  { section: 'feature-flags', title: 'Feature Flags', icon: 'toggle-left', category: 'api' },
  { section: 'advanced-rate-limiter', title: 'Rate Limiter', icon: 'gauge', category: 'api' },
  { section: 'file-storage', title: 'File Storage', icon: 'hard-drive', category: 'api' },
  { section: 'pdf-generator', title: 'PDF Generator', icon: 'file-text', category: 'api' },
  { section: 'audit-log', title: 'Audit Log', icon: 'scroll', category: 'api' },
  { section: 'multitenancy', title: 'Multi-tenancy', icon: 'building', category: 'api' },
  { section: 'i18n', title: 'i18n / Localization', icon: 'languages', category: 'api' },
  { section: 'alerting-rules', title: 'Alerting Rules', icon: 'bell', category: 'api' },
  { section: 'request-replay', title: 'Request Replay', icon: 'play', category: 'api' },
  { section: 'interactive-api-explorer', title: 'API Explorer UI', icon: 'radar', category: 'api' },
  { section: 'database-studio', title: 'Database Studio', icon: 'layout-dashboard', category: 'api' },
  { section: 'read-replicas', title: 'Read Replicas', icon: 'copy', category: 'api' },
  { section: 'factory-seeder', title: 'Factory Seeder', icon: 'sprout', category: 'api' },
  { section: 'soft-delete', title: 'Soft Delete', icon: 'trash-2', category: 'api' },
  { type: 'divider' },
  { section: 'sse', title: 'Server-Sent Events', icon: 'radio', category: 'api' },
  { section: 'push-notifications', title: 'Push Notifications', icon: 'bell-ring', category: 'api' },
  { section: 'sms-providers', title: 'SMS Providers', icon: 'phone', category: 'api' },
  { section: 'llm-gateway', title: 'LLM Gateway', icon: 'brain', category: 'api' },
  { section: 'vector-search', title: 'Vector Search', icon: 'search', category: 'api' },
  { section: 'background-jobs', title: 'Background Jobs', icon: 'cog', category: 'api' },
  { section: 'rbac', title: 'RBAC / Permissions', icon: 'shield-check', category: 'api' },
  { section: 'oauth2-server', title: 'OAuth2 Server', icon: 'key', category: 'api' },
  { section: 'totp-2fa', title: '2FA / TOTP', icon: 'lock', category: 'api' },
  { section: 'full-text-search', title: 'Full-Text Search', icon: 'search', category: 'api' },
  { section: 'data-export', title: 'Data Export', icon: 'download', category: 'api' },
  { section: 'event-sourcing', title: 'Event Sourcing', icon: 'git-commit', category: 'api' },
  { section: 'circuit-breaker', title: 'Circuit Breaker', icon: 'zap-off', category: 'api' },
  { section: 'config-vault', title: 'Config Vault', icon: 'vault', category: 'api' },
  { section: 'graphql-subscriptions', title: 'GraphQL Subscriptions', icon: 'git-branch', category: 'api' },
  { type: 'divider' },
  { section: 'guide-changelog', title: 'Auto Changelog', icon: 'scroll-text', category: 'how-to' },
  { section: 'guide-scaffold-api', title: 'Scaffold API', icon: 'layers', category: 'how-to' },
  { type: 'divider' },
