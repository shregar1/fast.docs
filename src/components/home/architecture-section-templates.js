export const MERMAID_SYSTEM = `flowchart TB
...
export const MERMAID_CACHE_TREE = `flowchart TD
...
function diagramBlockTemplate(step, title, description, mermaidSource) {
  return `
...
export function architecturePageTemplate() {
  return `
