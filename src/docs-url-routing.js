...
export const DOC_SECTION_ALIASES = {
  ...
  monorepo: 'ecosystem',
  packages: 'ecosystem',
  platform: 'pkg-fastx-platform',
  'fastx-platform': 'pkg-fastx-platform',
  middleware: 'pkg-fastx-middleware',
  'fastx-middleware': 'pkg-fastx-middleware',
  'fastx-database': 'pkg-fastx-database',
  dashboards: 'pkg-fastx-dashboards',
  'fastx-dashboards': 'pkg-fastx-dashboards',
  channels: 'pkg-fast-channels',
  'fast-channels': 'pkg-fast-channels',
  websocket: 'pkg-fast-channels',
  mvc: 'pkg-fastx-mvc',
  'fastx-mvc': 'pkg-fastx-mvc',
};
